"""Stage 6 -- publish, and stage 7 -- diff.
...
Stage 7 is the one that turns extraction into the actual product. Compliance
...
from .vectors import cosine, local_embedding
...
def _write_review_queue(items: list[Item], path: Path, flags=()) -> None:
    from .route import review_queue
