...
Why a graph rather than a function that calls seven functions:
...
from .judge import score_priority
from .llm import Gateway
from .observability import RunRecorder
from .publish import published_items, write_outputs
from .publog import PublishLog
from .retrieval import resolve_references
from .review import append_gold_corrections, apply_decisions, parse_decisions, review_request
from .route import BLOCKING_FLAG_CODES, apply_document_flags, route, routing_summary
from .segment import segment, structure_report
from .verify import document_flags, verify
